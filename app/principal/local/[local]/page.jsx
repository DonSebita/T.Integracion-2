...
if (params.local >= 0 && params.local < 5) {
  return (
    <main className="grid grid-flow-row auto-rows-max bg-primero">
      <section className="flex flex-col h-screen items-center w-full bg-segundo px-2 sm:px-4 md:px-6 lg:px-8">
        <div className="w-full md:w-3/5 bg-primero p-4 md:p-14">
          ...
          <h2 className="pt-4 md:pt-14 text-black font-bold border-b-4 text-xl">
            Informacion:
          </h2>
          <div className="pt-2 text-black">
            <h2 className="font-bold">Ubicacion:</h2>
            <p className="pl-2 md:pl-5 pb-3">{locales[params.local].ubicacion}</p>
            <h2 className="font-bold">Encargado:</h2>
            <p className="pl-2 md:pl-5 pb-3">{locales[params.local].encargado}</p>
            <h2 className="font-bold">Horario:</h2>
            <div className="pl-2 md:pl-5 pb-3">
            ...
            <p className="pl-2 md:pl-5">Ubicacion bien ubicada</p>
          </div>
        </div>
        <div className="flex justify-center py-6 md:py-20 w-full md:w-2/5 bg-segundo ">
          <iframe
