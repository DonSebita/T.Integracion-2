...
const Carrusel = (props) => {
    ...
    return (
        <div class="flex items-center justify-center h-auto relative my-10">
            <div class="mx-4 relative  h-auto">
                <Image src={ListaImg[imagen]}
                    width={1000}
                    height={500}
                ...
                <div class="absolute inset-0 flex justify-between">
                    <button
                        class="p-2 text-black opacity-100 text-6xl hover:text-white hover:bg-opacity-50"
